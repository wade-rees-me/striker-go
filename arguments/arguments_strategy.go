...
func init() {
	...
	flag.BoolVar(&CLStrategy.LinearFlag, "strategy-linear", false, "Use the linear regression strategy tables. (This option is currently unimplemented)")
	flag.BoolVar(&CLStrategy.PolynomialFlag, "strategy-polynomial", false, "Use the polynomial regression strategy tables. (This option is currently unimplemented)")
}
